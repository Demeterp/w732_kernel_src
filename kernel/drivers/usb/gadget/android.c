...
#define MANUFACTURER_STRING "PHILIPS"
#define PRODUCT_STRING "W732"
#elif defined(I5000_A10)
#define MANUFACTURER_STRING "SAGETEL "
#define PRODUCT_STRING "A10"
#elif defined(C8_E350)//sunyugang add 20120705
#define MANUFACTURER_STRING "Acer"
#define PRODUCT_STRING "E350"
#else
#define MANUFACTURER_STRING "MediaTek"
#define PRODUCT_STRING "MT65xx Android Phone"
#endif

/*Default adb device name*/
#if defined(C8_AK330)
	#define ADB_DEVICE_STRING "Acer AK330"
#elif defined(C8_E350)//yuanhl add 20120418
	#define ADB_DEVICE_STRING "Acer E350"
#elif defined(PHILIPS_ATLAS)
	#define ADB_DEVICE_STRING "PHILIPS W732"
#elif defined(I5000_A10)
        #define ADB_DEVICE_STRING "SAGETEL A10"
#else
	#define ADB_DEVICE_STRING "0123456789ABCDEF"
#endif
...
static int android_bind(struct usb_composite_dev *cdev)
{
	...
	strncpy(product_string, PRODUCT_STRING, sizeof(product_string) - 1);
        strncpy(serial_string, "Acer E350", sizeof(serial_string) - 1);      
...
/* begin wpf add for adb test tools */
...
/* end wpf add for adb test tools */
