...
*/
  ...
  //;cmx
OV7690_write_cmos_sensor(0xbb,0x80);
OV7690_write_cmos_sensor(0xbc,0x62);
OV7690_write_cmos_sensor(0xbd,0x1e);
OV7690_write_cmos_sensor(0xbe,0x26);
OV7690_write_cmos_sensor(0xbf,0x7b);
OV7690_write_cmos_sensor(0xc0,0xac);
OV7690_write_cmos_sensor(0xc1,0x1e);

//;gamma
OV7690_write_cmos_sensor(0xa3,0x08);
OV7690_write_cmos_sensor(0xa4,0x15);
OV7690_write_cmos_sensor(0xa5,0x24);
OV7690_write_cmos_sensor(0xa6,0x45);    
OV7690_write_cmos_sensor(0xa7,0x55);
OV7690_write_cmos_sensor(0xa8,0x6a);
OV7690_write_cmos_sensor(0xa9,0x78);
OV7690_write_cmos_sensor(0xaa,0x87);
OV7690_write_cmos_sensor(0xab,0x96);
OV7690_write_cmos_sensor(0xac,0xa3);
OV7690_write_cmos_sensor(0xad,0xb4);
OV7690_write_cmos_sensor(0xae,0xc3);
OV7690_write_cmos_sensor(0xaf,0xd6);
OV7690_write_cmos_sensor(0xb0,0xe6);
OV7690_write_cmos_sensor(0xb1,0xf2);
OV7690_write_cmos_sensor(0xb2,0x12); 

/* AEC/AGC target */
  /*This only in fixed frame change!*/
  OV7690_write_cmos_sensor(0x24, 0x78);
  OV7690_write_cmos_sensor(0x25, 0x68);
  OV7690_write_cmos_sensor(0x26, 0xa5);


  //maliyan 2011-12-15
  //===Lens Correction==
	OV7690_write_cmos_sensor(0x80, 0x7f);
	OV7690_write_cmos_sensor(0x85, 0x10);
	OV7690_write_cmos_sensor(0x86, 0x10);
	OV7690_write_cmos_sensor(0x87, 0x10);
	OV7690_write_cmos_sensor(0x88, 0x80);
	OV7690_write_cmos_sensor(0x89, 0x2a);
	OV7690_write_cmos_sensor(0x8a, 0x25);
	OV7690_write_cmos_sensor(0x8b, 0x25);
	
	//====Color Matrix======
	OV7690_write_cmos_sensor(0xbe, 0x1d);
	OV7690_write_cmos_sensor(0xbf, 0x73);
	OV7690_write_cmos_sensor(0xc0, 0x8f);
	OV7690_write_cmos_sensor(0xbb, 0x80);
	OV7690_write_cmos_sensor(0xbc, 0xa0);
	OV7690_write_cmos_sensor(0xbd, 0x20);
	OV7690_write_cmos_sensor(0xc1, 0x1a);
	
	//===Edge + Denoise====
	OV7690_write_cmos_sensor(0xb4, 0x06);
	OV7690_write_cmos_sensor(0xb5, 0x05);
	OV7690_write_cmos_sensor(0xb6, 0x00);
	OV7690_write_cmos_sensor(0xb7, 0x00);
	OV7690_write_cmos_sensor(0xb8, 0x06);
	OV7690_write_cmos_sensor(0xb9, 0x02);
	OV7690_write_cmos_sensor(0xba, 0x78);
	
	
	//====AEC/AGC target===
	OV7690_write_cmos_sensor(0x24, 0x7a);
	OV7690_write_cmos_sensor(0x25, 0x6a);
	OV7690_write_cmos_sensor(0x26, 0x95);
	
	
	//=====UV adjust======
	OV7690_write_cmos_sensor(0x81, 0xff);
	OV7690_write_cmos_sensor(0x5A, 0x10);
	OV7690_write_cmos_sensor(0x5B, 0xa1);
	OV7690_write_cmos_sensor(0x5C, 0x3a);
	...
	OV7690_write_cmos_sensor(0xa4, 0x10);	  
	OV7690_write_cmos_sensor(0xa5, 0x25);	  
	OV7690_write_cmos_sensor(0xa6, 0x40);	  
	OV7690_write_cmos_sensor(0xa7, 0x56);	  
	OV7690_write_cmos_sensor(0xa8, 0x64);	  
	OV7690_write_cmos_sensor(0xa9, 0x70);	  
	OV7690_write_cmos_sensor(0xaa, 0x7c);	  
	OV7690_write_cmos_sensor(0xab, 0x87);	  
	OV7690_write_cmos_sensor(0xac, 0x90);	  
	OV7690_write_cmos_sensor(0xad, 0x9f);	  
	OV7690_write_cmos_sensor(0xae, 0xAc);	  
	OV7690_write_cmos_sensor(0xaf, 0xC1);	  
	OV7690_write_cmos_sensor(0xb0, 0xD5);	  
	...
	OV7690_write_cmos_sensor(0x92, 0x8e);  
	OV7690_write_cmos_sensor(0x93, 0x85); 
	OV7690_write_cmos_sensor(0x94, 0x0e); 
	OV7690_write_cmos_sensor(0x95, 0x0c);
	OV7690_write_cmos_sensor(0x96, 0xf0);  
	OV7690_write_cmos_sensor(0x97, 0x10);  
	OV7690_write_cmos_sensor(0x98, 0x39);  
	OV7690_write_cmos_sensor(0x99, 0x41);  
	OV7690_write_cmos_sensor(0x9a, 0x48);  
	OV7690_write_cmos_sensor(0x9b, 0x34);  
	OV7690_write_cmos_sensor(0x9c, 0xf0);  
	OV7690_write_cmos_sensor(0x9d, 0xf0); 
	OV7690_write_cmos_sensor(0x9e, 0xf0);  
	OV7690_write_cmos_sensor(0x9f, 0xff); 
	OV7690_write_cmos_sensor(0xa0, 0x61);  
	OV7690_write_cmos_sensor(0xa1, 0x56);  
	OV7690_write_cmos_sensor(0xa2, 0x0c); 
	
	OV7690_write_cmos_sensor(0x14, 0x10);
	OV7690_write_cmos_sensor(0x13, 0xf7);
	OV7690_write_cmos_sensor(0x1e, 0x33);
	
	OV7690_write_cmos_sensor(0x50, 0x49),
	
	OV7690_write_cmos_sensor(0x68, 0xb2);
	
	//davis add denoise 
	OV7690_write_cmos_sensor(0xb4, 0x10);
	OV7690_write_cmos_sensor(0xb5, 0x0b);
#else//Z100 setting
	...
	OV7690_write_cmos_sensor(0x41,0x43);
	OV7690_write_cmos_sensor(0x4c,0x73);
	OV7690_write_cmos_sensor(0x81,0xff);
	OV7690_write_cmos_sensor(0x81,0xef);
	OV7690_write_cmos_sensor(0x21,0x44);
	OV7690_write_cmos_sensor(0x16,0x03);
	OV7690_write_cmos_sensor(0x39,0x80);
	OV7690_write_cmos_sensor(0x1e,0xb1);
	...
	OV7690_write_cmos_sensor(0x80,0x7f);
	OV7690_write_cmos_sensor(0x3e,0x30);
	OV7690_write_cmos_sensor(0x22,0x00);

	//===Resolution===//

	OV7690_write_cmos_sensor(0x17,0x69);
	OV7690_write_cmos_sensor(0x18,0xa4);
	OV7690_write_cmos_sensor(0x19,0x0c);
	OV7690_write_cmos_sensor(0x1a,0xf6);

	OV7690_write_cmos_sensor(0xc8,0x02);  
	OV7690_write_cmos_sensor(0xc9,0x80); //ISP input hsize (640)
	OV7690_write_cmos_sensor(0xca,0x01);  
	OV7690_write_cmos_sensor(0xcb,0xe0); //ISP input vsize (480)

	OV7690_write_cmos_sensor(0xcc,0x02); 
	OV7690_write_cmos_sensor(0xcd,0x80); //ISP output hsize (640)
	OV7690_write_cmos_sensor(0xce,0x01);
	OV7690_write_cmos_sensor(0xcf,0xe0);//ISP output vsize (480)

	//===Lens Correction==//
	OV7690_write_cmos_sensor(0x85,0x90);
	OV7690_write_cmos_sensor(0x86,0x18);
	OV7690_write_cmos_sensor(0x86,0x00);
	OV7690_write_cmos_sensor(0x87,0x00);
	OV7690_write_cmos_sensor(0x88,0x10);
	OV7690_write_cmos_sensor(0x89,0x30);
	OV7690_write_cmos_sensor(0x8a,0x29);
	OV7690_write_cmos_sensor(0x8b,0x26);
	OV7690_write_cmos_sensor(0x89,0x18);
	OV7690_write_cmos_sensor(0x8a,0x10);
	OV7690_write_cmos_sensor(0x8b,0x14);

	//====Color Matrix====//

	OV7690_write_cmos_sensor(0xbb,0x89);
	OV7690_write_cmos_sensor(0xbc,0x8b);
	OV7690_write_cmos_sensor(0xbd,0x01);
	OV7690_write_cmos_sensor(0xbe,0x18);
	OV7690_write_cmos_sensor(0xbf,0x75);
	OV7690_write_cmos_sensor(0xc0,0x8d);
	OV7690_write_cmos_sensor(0xc1,0x1a);

	OV7690_write_cmos_sensor(0xBB,0x20);
	OV7690_write_cmos_sensor(0xBC,0x40);
	OV7690_write_cmos_sensor(0xBD,0x60);
	OV7690_write_cmos_sensor(0xBE,0x58);
	OV7690_write_cmos_sensor(0xBF,0x48);
	OV7690_write_cmos_sensor(0xC0,0x10);
	OV7690_write_cmos_sensor(0xC1,0x33);
	OV7690_write_cmos_sensor(0xc2,0x02);

	//===Edge + Denoise====//
	OV7690_write_cmos_sensor(0xb7,0x02);
	OV7690_write_cmos_sensor(0xb8,0x0b);
	OV7690_write_cmos_sensor(0xb9,0x00);
	OV7690_write_cmos_sensor(0xba,0x18);

	//===UVAdjust====//
	OV7690_write_cmos_sensor(0x5A,0x4A);
	OV7690_write_cmos_sensor(0x5B,0x9F);
	OV7690_write_cmos_sensor(0x5C,0x48);
	OV7690_write_cmos_sensor(0x5d,0x32);
	...
	//====Gamma====//
	OV7690_write_cmos_sensor(0xa3,0x10);
	OV7690_write_cmos_sensor(0xa4,0x1c);
	OV7690_write_cmos_sensor(0xa5,0x30);
	OV7690_write_cmos_sensor(0xa6,0x58);
	OV7690_write_cmos_sensor(0xa7,0x68);
	OV7690_write_cmos_sensor(0xa8,0x76);
	OV7690_write_cmos_sensor(0xa9,0x81);
	OV7690_write_cmos_sensor(0xaa,0x8a);
	OV7690_write_cmos_sensor(0xab,0x94);
	OV7690_write_cmos_sensor(0xac,0x9c);
	OV7690_write_cmos_sensor(0xad,0xa8);
	OV7690_write_cmos_sensor(0xae,0xb4);
	OV7690_write_cmos_sensor(0xaf,0xc6);
	...
	//==Simple==//
	OV7690_write_cmos_sensor(0x8e,0x92);// simple AWB
	OV7690_write_cmos_sensor(0x96,0xff);
	OV7690_write_cmos_sensor(0x97,0x00);//unlimit AWB range.

	//==Advance==//
	OV7690_write_cmos_sensor(0x8c,0x5d);
	OV7690_write_cmos_sensor(0x8d,0x11);
	OV7690_write_cmos_sensor(0x8e,0x12);
	OV7690_write_cmos_sensor(0x8f,0x11);
	OV7690_write_cmos_sensor(0x90,0x50);
	OV7690_write_cmos_sensor(0x91,0x22);
	OV7690_write_cmos_sensor(0x92,0xd1);
	OV7690_write_cmos_sensor(0x93,0xa7);
	OV7690_write_cmos_sensor(0x94,0x23);
	OV7690_write_cmos_sensor(0x24,0x88);
	OV7690_write_cmos_sensor(0x25,0x78);
	OV7690_write_cmos_sensor(0x26,0xc4);
	OV7690_write_cmos_sensor(0x95,0x3b);
	OV7690_write_cmos_sensor(0x96,0xff);
	OV7690_write_cmos_sensor(0x97,0x00);
	OV7690_write_cmos_sensor(0x98,0x4a);
	OV7690_write_cmos_sensor(0x99,0x46);
	OV7690_write_cmos_sensor(0x9a,0x3d);
	OV7690_write_cmos_sensor(0x9b,0x3a);
	OV7690_write_cmos_sensor(0x9c,0xf0);
	OV7690_write_cmos_sensor(0x9d,0xf0);
	OV7690_write_cmos_sensor(0x9e,0xf0);
	OV7690_write_cmos_sensor(0x9f,0xff);
	OV7690_write_cmos_sensor(0xa0,0x56);
	OV7690_write_cmos_sensor(0xa1,0x55);
	OV7690_write_cmos_sensor(0xa2,0x13);

	//==General Control==//
	OV7690_write_cmos_sensor(0x50,0x4d);//,0x;4c
	OV7690_write_cmos_sensor(0x51,0x3f);
	OV7690_write_cmos_sensor(0x21,0x57);//	;Steps
	OV7690_write_cmos_sensor(0x20,0x00);

	OV7690_write_cmos_sensor(0x14,0x29);
	OV7690_write_cmos_sensor(0x14,0x39);
	OV7690_write_cmos_sensor(0x14,0x49);
	OV7690_write_cmos_sensor(0x13,0xf7);
	OV7690_write_cmos_sensor(0x11,0x01);
	OV7690_write_cmos_sensor(0x68,0xb0);
	OV7690_write_cmos_sensor(0x42,0x0d);//;,0x2.6-3.0V
	OV7690_write_cmos_sensor(0x42,0x04);//;,0x2.1-2.5V
	OV7690_write_cmos_sensor(0x42,0x0c);//;,0x1.7-2.0V
...

{
	...
	//this section is moved from OV7690_Preview(), solve that no WB effect after capture
...

{
	...
	OV7690_FPS(30);
#if 0   //chenhaojun 20120307
	sensor_config_data->SensorImageMirror= IMAGE_HV_MIRROR;//add
#else
#endif
	...
	OV7690_write_cmos_sensor(0x14,0x29);//for banding 50HZ  //0x21
	OV7690AeEnable(KAL_TRUE);
	//this section is moved to OV7690Open(), solve that no WB after capture
	//OV7690AwbEnable(KAL_TRUE);
	//OV7690_write_cmos_sensor(0x13,0xf7);
...
static BOOL OV7690_set_param_banding(UINT16 para)
{
	...
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			OV7690_write_cmos_sensor(0x14, 0x29);//0x21
			break;
...
#if defined(PHILIPS_ATLAS)  /*copy Z100A*/
static BOOL OV7690_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		case AE_EV_COMP_00:	// Disable EV compenate
			OV7690_write_cmos_sensor(0x81, 0xef); 
			OV7690_write_cmos_sensor(0xD3, 0x30); 
			OV7690_write_cmos_sensor(0xD2, 0x04); 
			OV7690_write_cmos_sensor(0xDc, 0x01); 
			break;
		case AE_EV_COMP_05:// EV compensate 0.5
			OV7690_write_cmos_sensor(0x81, 0xef); 
			OV7690_write_cmos_sensor(0xD3, 0x40); 
			OV7690_write_cmos_sensor(0xD2, 0x04); 
			OV7690_write_cmos_sensor(0xDc, 0x01); 
			break;
		case AE_EV_COMP_10:// EV compensate 1.0
			OV7690_write_cmos_sensor(0x81, 0xef); 
			OV7690_write_cmos_sensor(0xD3, 0x50); 
			OV7690_write_cmos_sensor(0xD2, 0x04); 
			OV7690_write_cmos_sensor(0xDc, 0x01); 
			break;
		case AE_EV_COMP_15:// EV compensate 1.5
			OV7690_write_cmos_sensor(0x81, 0xef); 
			OV7690_write_cmos_sensor(0xD3, 0x60); 
			OV7690_write_cmos_sensor(0xD2, 0x04); 
			OV7690_write_cmos_sensor(0xDc, 0x01); 
			break;
		case AE_EV_COMP_20:// EV compensate 2.0
			OV7690_write_cmos_sensor(0x81, 0xef); 
			OV7690_write_cmos_sensor(0xD3, 0x70); 
			OV7690_write_cmos_sensor(0xD2, 0x04); 
			OV7690_write_cmos_sensor(0xDc, 0x01); 
			break;
		case AE_EV_COMP_n05:// EV compensate -0.5
			OV7690_write_cmos_sensor(0x81, 0xef); 
			OV7690_write_cmos_sensor(0xD3, 0x20); 
			OV7690_write_cmos_sensor(0xD2, 0x04); 
			OV7690_write_cmos_sensor(0xDc, 0x01); 
			break;
