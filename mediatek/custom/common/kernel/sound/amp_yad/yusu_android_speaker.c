...
//#define EXTERNAL_AMPLIFIER_GPIO (68)//LK@mask
...
bool Speaker_Init(void)
{
   ...
   mt_set_gpio_pull_select(GPIO_SPEAKER_EN_PIN, GPIO_PULL_DOWN);//LK@add
...
void Sound_Speaker_Turnon(int channel)
{
	...
	if(gsk_on)
		return;
    mt_set_gpio_mode(GPIO_SPEAKER_EN_PIN,GPIO_MODE_00);  //LK@add
