...
static int  cm3623_local_init(void);
static int cm3623_remove(void);
static int cm3623_init_flag =0;
static struct sensor_init_info cm3623_init_info = {		
	.name = "cm3623",		
	.init = cm3623_local_init,		
	.uninit = cm3623_remove,	
};
...
#if defined(ACER_C8)|| defined(SIMCOM_I5000) //amy0504 
	if(power_on == on)
	{
		APS_LOG("ignore power control: %d\n", on);
	}
...
static int cm3623_enable_als(struct i2c_client *client, int enable)
{
	...
	if(enable)
	{
		...
		obj->hw = cm3623_get_cust_alsps_hw();
...
static int cm3623_get_als_value(struct cm3623_priv *obj, u16 als)
{
	...
	als=als*1000/C_CUST_ALS_FACTOR;
		...
		//printk("cm3623 #####cm3623_get_als_value\r\n");
...
static int cm3623_get_ps_value(struct cm3623_priv *obj, u16 ps)
{
	...
	int invalid = 0;
	//	printk("cm3623 #####cm3623_get_ps_value\r\n");
...
static int cm3623_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	atomic_set(&obj->als_suspend, 0);
#if 0 //amy0509_1 defined(SIMCOM_I5000)  //amy0504
	...
	{
#if  0  //amy0509_1defined(SIMCOM_I5000) //amy0504
	...
	if((err = cm3623_create_attr(&cm3623_init_info.platform_diver_addr->driver)))
	{
...
static int cm3623_i2c_remove(struct i2c_client *client)
{
	...
	if((err = cm3623_delete_attr(&cm3623_init_info.platform_diver_addr->driver)))
	{
...
static int  cm3623_local_init(void)
{
	struct alsps_hw *hw = cm3623_get_cust_alsps_hw();
	struct cm3623_i2c_addr addr;
...
{
	APS_FUN();
		//		printk("cm3623 #####cm3623_init  \r\n");	

#if  1 //amy0510 add
	i2c_register_board_info(0, &i2c_cm3623, 1); //amy0511 add  add

hwmsen_alsps_sensor_add(&cm3623_init_info); //amy0510 
#else
