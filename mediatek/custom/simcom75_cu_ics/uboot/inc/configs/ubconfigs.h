...
#if defined(PHILIPS_ATLAS)||defined(SIMCOM_I5000)||defined(PHILIPS_TITAN) //amy0504 
#define MT65XX_FACTORY_KEY	10	/* use Volume Down's hardware keycode for keypad matrix; use MT65XX_PMIC_RST_KEY for PMIC */
#elif defined(ACER_C8)
#define MT65XX_FACTORY_KEY	0
#else
//#define MT65XX_FACTORY_KEY	2	//LK@ defined in cust_kpd.h /* use Volume Down's hardware keycode for keypad matrix; use MT65XX_PMIC_RST_KEY for PMIC */
#endif
//#define MT65XX_RECOVERY_KEY  defined in cust_kpd.h
