...
#define CONFIG_MTK_USB_UNIQUE_SERIAL //E350 yuan m 20120728
...
int get_serial(uint64_t hwkey, uint32_t chipid, char ser[SERIALNO_LEN])
{
	...
	//wentao 2012.7.13 for googleplay can not login
    //ser[0] = 'M';
    //ser[1] = 'T';
    //ser[2] = '-';
    ser_idx = 0;
...
#if defined(CONFIG_MTK_TOUCHPANEL) && defined(PHILIPS_ATLAS)
