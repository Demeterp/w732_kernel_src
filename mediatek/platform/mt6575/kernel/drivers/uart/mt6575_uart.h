...
#ifndef __MT6575_UART_H__
#define __MT6575_UART_H__
...
#define UART_NR                     4
/*---------------------------------------------------------------------------*/
#define MT6575_SYSCLK_65            65000000
#define MT6575_SYSCLK_49_4        49400000
#define MT6575_SYSCLK_58_5          58500000
#define MT6575_SYSCLK_52            52000000
#define MT6575_SYSCLK_26            26000000
#define MT6575_SYSCLK_13            13000000
#define MT6575_SYSCLK_6144          61440000
#define MT6575_SYSCLK_3072          30720000
#define MT6575_SYSCLK_1536          15360000
/*---------------------------------------------------------------------------*/
#if !defined(CONFIG_ARCH_MT6575)
#error NOT 6575 Platform!!
#elif defined(CONFIG_MT6575_FPGA)
#define UART_SYSCLK                 13500000
#else
//#define UART_SYSCLK                 MT6575_SYSCLK_65
#define UART_SYSCLK                 MT6575_SYSCLK_49_4 
#endif
/*---------------------------------------------------------------------------*/
...
do {    \
    if ((DBG_EVT_##evt) & mt6575_uart_evt_mask[uart->nport]) { \
        const char *s = #evt;                                  \
...
/*---------------------------------------------------------------------------*/
#define UART_DEBUG_EVT(evt)    ((evt) & mt6575_uart_evt_mask[uart->nport])
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
struct mt6575_uart_vfifo
{
    struct mt6575_uart_dma      *dma;    /* vfifo dma owner */    
    ...
    struct mt6575_uart_buf      dbg[C_UART_DEBUG_BUF_NUM];
    struct mt6575_uart_buf      *cur;
    int                         dbgidx;
    unsigned int        irq_id;
};
/*---------------------------------------------------------------------------*/
struct mt6575_uart_dma {
...
struct mt6575_uart
{
    ...
    struct mt6575_uart_dma dma_tx;
    struct mt6575_uart_dma dma_rx;
    struct mt6575_uart_vfifo *tx_vfifo;
    struct mt6575_uart_vfifo *rx_vfifo;

#ifdef ENABLE_DEBUG
    struct mt6575_uart_regs *debug;
#endif
    struct mt6575_uart_setting* setting;

    unsigned int (*write_allow)(struct mt6575_uart *uart);
    unsigned int (*read_allow)(struct mt6575_uart *uart);
    void         (*write_byte)(struct mt6575_uart *uart, unsigned int byte);
    unsigned int (*read_byte)(struct mt6575_uart *uart);
    unsigned int (*read_status)(struct mt6575_uart *uart);
};
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
/* For MT6575, both RX and TX will not use port to send or receive data */
/* IER */
...
#define UART_MCR_DCM_EN             (1 << 5)    /* MT6575 move to bit5 */
...
/*---------------------------------------------------------------------------*/
struct mt6575_dma_vfifo_reg {
    struct mt6575_vfifo_tx_reg tx;
    struct mt6575_vfifo_rx_reg rx;
};
