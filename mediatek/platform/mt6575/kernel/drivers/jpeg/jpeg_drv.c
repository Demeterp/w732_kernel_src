...
#include "jpeg_drv.h"
#include "jpeg_drv_6575_common.h"
...
#define JPEG_DEVNAME "mt6575_jpeg"
...
static irqreturn_t jpeg_drv_isr(int irq, void *dev_id)
{
    ...
    if(irq == MT6575_JPEG_CODEC_IRQ_ID)
    {
...
static int jpeg_probe(struct platform_device *pdev)
{
    ...
    enable_irq(MT6575_JPEG_CODEC_IRQ_ID);
    if(request_irq(MT6575_JPEG_CODEC_IRQ_ID, jpeg_drv_isr, IRQF_TRIGGER_LOW, "jpeg_driver" , NULL))
    {
...
#ifndef FPGA_VERSION
	free_irq(MT6575_JPEG_CODEC_IRQ_ID, NULL);
#endif
	JPEG_MSG("Done\n");
	return 0;
}
