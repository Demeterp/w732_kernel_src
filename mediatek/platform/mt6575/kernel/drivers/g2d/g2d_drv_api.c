...
static void _g2d_drv_set_bitblt_info(g2d_context_t *g2d_ctx)
{
    ...
    for (i = 0; i < g2d_ctx->num_layer; i++)
    {
        ...
        if (g2d_ctx->enable_alpha_blending == 1)
        {
            ENABLE_G2D_LAYER_CON_ALPHA(i+1);
            SET_G2D_LAYER_CON_ALPHA(i+1, g2d_ctx->const_alpha);
        }
    }
}
...
static void _g2d_drv_set_affine_info(g2d_context_t *g2d_ctx)
{
    ...
    if (g2d_ctx->enable_alpha_blending == 1)
    {
        ...
        SET_G2D_LAYER_CON_ALPHA(1, g2d_ctx->const_alpha);
    }
}
...
void g2d_drv_run(g2d_context_t *g2d_ctx)
{
    ...
    if (g2d_ctx->enable_affine_transform)
